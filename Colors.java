...
public class Colors {
    ...
    // TEXT COLORS
    public static final Color CAVIAR = new Color(44, 43, 44);                 // Caviar Black
    public static final Color CAVIAR_SECONDARY = new Color(44, 43, 44);       // Caviar Black
    public static final Color CAVIAR_DARK = new Color(44, 43, 44);            // Caviar Black
    ...
    public static Color getColor(String name) {
        switch (name.toUpperCase()) {
            ...
            default: return CAVIAR;          // Caviar Black
        }
    }
}
